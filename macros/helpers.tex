...
\newcommand{\kp}{KitPhishr}
\newcommand{\ji}{Jaccard index}
...
\ifthenelse{\boolean{showcomments}}
  {\newcommand{\nb}[2]{
  \fbox{\bfseries\sffamily\small\texttt{#1}}
     {\sf\small$\blacktriangleright$\texttt{\textcolor{red}{#2}}$\blacktriangleleft$}
   }
  }
  {\newcommand{\nb}[2]{}
