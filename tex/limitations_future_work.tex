...
\subsection{Incorrect Ground truth mapping}
...
\subsection{Unexplored Page states}
While we visit and loiter on phishing pages, we do not explore and interact with the pages. With recent work in LLM-powered crawlers, and ML-guided browser automation\cite{PhishingInPattern}, we leave this to future work to use to collect a more complete list of browser APIs executed by a phishing page, at all stages of the phishing page.
% \subsection{Variance}
