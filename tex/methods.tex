...
In order to filter out noise in trends from the miss-balance of pages we get from different feeds, we ignore any API trends that strongly corolate with the number of pages we get from all feeds.
