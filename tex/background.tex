...
If a phishing page determines the client to be not a viable victim (e.g., a crawling bot, not in a specific country, etc.), it take actions to not serve real phishing content.
