...
\begin{lstlisting}[language=JavaScript,frame=L,caption={Example of a client-side IP check what ensures that the ISP type is not educational}, label={lst:ipban-snippet}]  % Start your code-block
